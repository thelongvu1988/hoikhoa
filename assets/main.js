...
// ==========================================
// 7. THƯ MỜI KỶ NIỆM VIP TICKET (FIX LỖI CRASH GIAO DIỆN)
// ==========================================
...
function ds(e, t) {
    ...
    o.scale(2, 2);
    if (r) { o.drawImage(n, 0, 0, i, a); } 
    else {
        o.fillStyle = "#f5efe0"; o.fillRect(0, 0, i, a);
        o.fillStyle = "rgba(30,58,138,0.06)"; for (let step = 0; step < a; step += 48) o.fillRect(0, step, i, 1);
    }
